...
$authorization->CheckCode(EnumPermission::现金管理);
...
// 自定义查询条件
$columnGeneral = ['Id', 'Amount', 'Remark', 'CreateTime'];
$columnEqual  = ['SiteId'];
$columnLike  = ['OperatorLoginName'];
...
$sql = 'select SQL_CALC_FOUND_ROWS ' . implode(',', $columns) . ' from EnterpriseCashHistory';
if (count($sqlWhere)) {
