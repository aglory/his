CREATE SCHEMA `HisLog` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin ;
...
)engine InnoDB default character set = utf8 collate = utf8_bin auto_increment=1			comment '接口日志表' ;
...
create table Operator(
	...
	CreateTime DATETIME not null 														comment '创建时间'
)engine InnoDB default character set = utf8 collate = utf8_bin auto_increment=1			comment '操作日志表' ;
